...
?>
<?php
session_start(); $id = $_GET['Tenbookxe'];
?>
...
<div class="book-tour">
    ...
    <div>
        <div id="content " role="main">
            ...
            <?php
            $tenchuyenxe = get_the_title();
            $khoihanh = get_field('diem_khoi_hanh');
            $diemden  = get_field('diem_den');
            $ngaykhoihanh = $_POST['ngaykhoihanh'];
            $chonxe = $_POST['chonxe'];
            if ($chonxe == 'Xe 4 Chổ') $giaxe = get_field('gia_xe_4_cho');
            else if ($chonxe == 'Xe 7 Chổ') $giaxe = get_field('gia_xe_7_cho');
            else if ($chonxe == 'Xe 16 Chổ') $giaxe = get_field('gia_xe_16_cho');
            else if ($chonxe == 'Xe 29 Chổ') $giaxe = get_field('gia_xe_29_cho');

            $link = get_site_url() ."/list-book?tenchuyen=" . $tenchuyenxe . "&diemkhoihanh=" . $khoihanh . "&diemden=" . $diemden . "&ngaykhoihanh=" . $ngaykhoihanh . "&chonxe=" . $diemden . "&chonxe=" . $chonxe . "&giaxe=" . $giaxe;
            ?>
                ...
                <article role="article" id="post_<?php the_ID() ?>" <?php post_class() ?>>
                    <div class="col-sm-8 ">
                        <div class="col-sm-12 bg-white box-book-tour-thongtin">
                            ...
                            <div class="col-sm-4">
                                <div class="col-sm-12">
                                    <strong><p>Loại Xe Thuê</p></strong>
                                    <?php echo $chonxe ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 bg-white box-book-tour-nguoidat">
                            ...
                            <div class="form-book-tour">
                                ...
                                <div class="col-sm-12 thongtin">
                                    <textarea  name="thongtin" id="thongtin" placeholder="Thông Tin Ghi Chú Thuê Xe"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 bg-white box-book-tour-submit">
                            <div class="col-sm-6 col-sm-offset-3">
                                <input required="required" type="checkbox" id="bookxecheck" name="bookxecheck" value="bookxecheck" class="required"> Tôi đã đọc và đồng ý với <a class="" data-toggle="modal" data-target="#myModal">Điều khoản và Quy định</a>
                            </div>
                        ...
                        <div class="col-sm-12 box-book-tour bg-white">
                            <div class="content">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-6">
                                        <strong class="title"><?php echo $khoihanh ?></strong>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <strong class="title"><?php echo $diemden ?></strong>
                                    </div>
                                </div>
                                <hr>
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-6">
                                        <p class="tien "><?php echo tien($giaxe); echo"đ" ?></p>
                                    </div>
                                </div>
                                <hr>
