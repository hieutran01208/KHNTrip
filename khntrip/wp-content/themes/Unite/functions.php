...
function unite_scripts() {
    ...
    wp_enqueue_style( 'animate', get_template_directory_uri().'/inc/css/animate.css' );
    ...
    wp_enqueue_script( 'wow', get_template_directory_uri() . '/inc/js/dev/wow.min.js', array('jquery') );
...
function custom_admin_bar( $menu ) {
    $menu->add_menu( array(
        'id' => 'menu1',
        'title' => 'Quản Lý Danh Sách Đặt',
        'href' => get_site_url() ."/list-book",
