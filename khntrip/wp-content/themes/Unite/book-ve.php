...
<div class="book-tour">
    ...
    <div>
        <div id="content " role="main">
            ...
            $diemxemve  = get_field('dia_chi_su_dung');
            $ngaykhoihanh = $_POST['ngaykhoihanh'];
            $slnguoilon = $_POST['slNguoiLon'];
            $sltreem = $_POST['slTreEm'];

            $link = get_site_url() ."/list-book?tenve=" . $tenve . "&gianguoilon=" . $gianguoilon . "&giatreem=" . $giatreem . "&ngayxem=" . $ngaykhoihanh  . "&diemxemve=" . $diemxemve . "&slnguoilon=" . $slnguoilon . "&sltreem=" . $sltreem;
            ?>
                    ...
                    <div class="col-sm-8 ">
                        <div class="col-sm-12 bg-white box-book-tour-thongtin">
                            ...
                            <div class="col-sm-8">
                                ...
                                <p>Ngày Sử Dụng <?php echo $_POST['ngaykhoihanh'] ?></p>
                            </div>
                            <div class="col-sm-4">
                                <div class="col-sm-6">
                        ...
                        <div class="col-sm-12 bg-white box-book-tour-submit">
                            <div class="col-sm-6 col-sm-offset-3">
                                <input required="required" type="checkbox" id="bookvecheck" name="bookvecheck" value="bookvecheck" class="required"> Tôi đã đọc và đồng ý với <a class="" data-toggle="modal" data-target="#myModal">Điều khoản và Quy định</a>
                            </div>
                        ...
                        <div class="col-sm-12 box-book-tour bg-white">
                            <div class="content">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-6">
                                        <strong class="title"><?php the_field("thoi_gian_hoat_đong") ?></strong>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <strong class="title"><?php the_field("dia_chi_su_dung"); ?></strong>
                                    </div>
                                </div>
                                <hr>
                                <div class="col-sm-12">
